...
- 2026/3/16-19 [Augmented Humans International Conference 2026](https://augmented-humans.org/)
  ...
  - 掲載
    ...
    - [国際会議AHs 2026において知能情報メディア課程の学生（池田教授グループ）がBest Demo Honorable Mentionを受賞【先端理工学部】](https://www.ryukoku.ac.jp/nc/news/entry-18308.html)
    - [国際会議AHs 2026で本学グループがBest Demo Honorable Mentionを受賞～パラクライミング支援を目指すARサイトガイド・システムが国際的に高評価～](https://www.imi.ryukoku.ac.jp/?p=17517)
...
- 2025/12/4 池田研究室＆クラス 懇親会
  ...
  - 参加（他）：羽賀 大輝，池田 聖, 学部2年生3名
  - 内容：3グループに分かれてクリスマスらしい料理を作り競った。
- 2025/11/14 クライミングジムでの撮影
  - 参加：池田 聖，政岡 幹也
  - 場所：Rock on the Beach（京田辺）
  - 内容：新学部パンフレット用の視覚障害者のクライミング支援に関する研究の実験の様子を写真撮影する取材を受けた。
- 11/14 クライミングジムでの予備実験
  - 参加：池田 聖，政岡 幹也
  - 場所：[Rock on the Beach](https://rock-on-the-beach.com/)（京田辺）
  - 内容：視覚障害者のクライミング支援に関する研究において試作ARシステム上の仮想物体を複数デバイスで共有して提示する機能の動作テストを実施した。
- 2025/11/13 付属平安中学校１年生模擬講義
  - 場所：瀬田キャンパス8号館
  - 参加：羽賀 大輝，井上 想子，政岡 幹也, 池田 聖
  - 内容：付属平安中学校１年生50名×2組に対してに対してHMDに関する模擬講義を実施。
    講義後Microsoft HoloLens2上で動作する「空中お絵かき」アプリ（羽賀 大輝）の体験デモを行った。
    事前に、HMDおよびアプリの操作法の習熟（11/6）に加えて12台のHMDを全生徒にスムーズに装着させ操作法を教えるリハーサル等の準備（11/12）をして臨んだ。
